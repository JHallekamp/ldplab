#ifndef WWU_LDPLAB_RTSCPU_STAGE_FACTORIES_HPP
#define WWU_LDPLAB_RTSCPU_STAGE_FACTORIES_HPP
...
namespace ldplab
{
    namespace rtscpu
    {
        /** @brief Abstract baseclass for pipeline stage factory baseclasses. */
        class IStageFactory
        {
        public:
             ...
             * @param[in] memory_info Memory information regarding the thread
             *                        for which the thread-local data instance
             *                        has to be created.
             * @param[in] configuration The current complete configuration, for
             *                          which the pipeline stage may be
             *                          created, if all factories within the 
        ...
        /** 
         * @brief Abstract baseclass for bounding volume intersection stage
         *        factories. 
         */
