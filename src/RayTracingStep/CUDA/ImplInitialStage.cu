...
namespace homogenous_light_bounding_sphere_projection
{
	...
	__global__ void createBatchKernel(
		...
		const InitialStageHomogenousLightBoundingSphereProjection::Rect* projection_buffer,
		const InitialStageHomogenousLightBoundingSphereProjection::HomogenousLightSource* light_buffer,
		const size_t* num_rays_buffer,
