...
std::shared_ptr<ldplab::rtsogl::RayTracingStep> 
    ldplab::rtsogl::Factory::createRTS(
        ...
        const RayTracingStepOpenGLInfo& info)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create "\
            "rtsogl::RayTracingStep instance, invalid experimental setup");
        return nullptr;
    }
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create "\
            "rtsogl::RayTracingStep instance, context creation failed");
        return nullptr;
    }
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create "\
            "rtsogl::RayTracingStep instance, pipeline stage creation failed");
        return nullptr;
    }
    context->pipeline = std::make_unique<rtsogl::Pipeline>(
        std::move(initial),
        std::move(rbvit),
        std::move(rpit),
        std::move(rpi),
    ...
    std::shared_ptr<RayTracingStep> rts(new RayTracingStep(std::move(context)));
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create "\
            "rtsogl::RayTracingStep instance, gpu context creation failed");
        return nullptr;
    }
...
bool ldplab::rtsogl::Factory::validateSetup(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info)
{
    bool error = false;   
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Experimental setup %i contains no "\
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Experimental setup %i contains "\
...
void ldplab::rtsogl::Factory::setTypes(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info)
{
    ...
    LDPLAB_LOG_INFO("RTSOGL factory: Light direction type is %s",
        setup.light_sources[0].direction->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Light intensity distribution type is %s",
        setup.light_sources[0].intensity_distribution->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Light polarisation type is %s",
        setup.light_sources[0].polarisation->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Particle bounding volume type is %s",
        setup.particles[0].bounding_volume->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Particle geometry type is %s",
        setup.particles[0].geometry->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Particle material type is %s",
        setup.particles[0].material->typeString());
    LDPLAB_LOG_INFO("RTSOGL factory: Eikonal solver type is %s",
        info.solver_parameters->typeString());
}

bool ldplab::rtsogl::Factory::validateTypeHomogeneity(
    const ExperimentalSetup& setup)
{
    ...
    for (size_t i = 1; i < setup.light_sources.size(); ++i)
    {
            ...
            m_light_direction_type)
        {
            ...
            LDPLAB_LOG_ERROR("RTSOGL factory: Found inconsistent light "\
    ...
    for (size_t i = 1; i < setup.particles.size(); ++i)
    {
        ...
        {
            only_homogenous_types = false;
            LDPLAB_LOG_ERROR("RTSOGL factory: Found inconsistent particle "\
...
bool ldplab::rtsogl::Factory::createContext(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    std::unique_ptr<Context>& context)
{
...
bool ldplab::rtsogl::Factory::createDataInstances(
    const ExperimentalSetup& setup, 
    const RayTracingStepOpenGLInfo& info,
    Context& context)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create bounding volume "\
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create particle "\
...
void ldplab::rtsogl::Factory::createBoundingSphereDataInstances(
    const ExperimentalSetup& setup, 
    const RayTracingStepOpenGLInfo& info,
    Context& context)
{
...
void ldplab::rtsogl::Factory::createRodParticleDataInstances(
    const ExperimentalSetup& setup, 
    const RayTracingStepOpenGLInfo& info,
    Context& context)
{
...
void ldplab::rtsogl::Factory::createParticleMaterialLinearOneDirectionalInstances(
    const ExperimentalSetup& setup, 
    const RayTracingStepOpenGLInfo& info, 
    Context& context)
{
...
bool ldplab::rtsogl::Factory::createPipelineStages(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context, 
    std::unique_ptr<IInitialStage>& initial, 
...
bool ldplab::rtsogl::Factory::createInitialStage(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context, 
    std::unique_ptr<IInitialStage>& stage)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create initial stage, "\
            "unsupported type combination");
        return false;
    }
}

bool ldplab::rtsogl::Factory::createInnerParticlePropagationStage(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context, 
    std::unique_ptr<IInnerParticlePropagationStage>& stage)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create inner particle "\
            "propagation stage, unsupported type combination");
        return false;
    }
}

bool ldplab::rtsogl::Factory::createRayBoundingVolumeIntersectionTestStage(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context, 
    std::unique_ptr<IRayBoundingVolumeIntersectionTestStage>& stage)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create ray bounding "\
            "volume intersection stage, unsupported type combination");
        return false;
    }
}

bool ldplab::rtsogl::Factory::createRayParticleInteractionStage(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context,
    std::unique_ptr<IRayParticleInteractionStage>& stage)
{
    ...
    {
        LDPLAB_LOG_ERROR("RTSOGL factory: Failed to create ray particle "\
            "interaction stage, unsupported type combination");
        return false;
    }
}

bool ldplab::rtsogl::Factory::createRayParticleIntersectionTestStage(
    const ExperimentalSetup& setup,
    const RayTracingStepOpenGLInfo& info,
    Context& context, 
