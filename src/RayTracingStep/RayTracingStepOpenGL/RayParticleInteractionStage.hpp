#ifndef WWU_LDPLAB_RTSOGL_RAY_PARTICLE_INTERACTION_HPP
#define WWU_LDPLAB_RTSOGL_RAY_PARTICLE_INTERACTION_HPP
...
namespace ldplab
{
    ...
    namespace rtsogl
    {
        ...
        public:
            ...
            /**
             * @brief Inherited via ldplab::rtsogl::IRayParticleInteractionStage.
             * @brief Calculating resulting rays of the interaction of the 
             *        incident ray with a particle surface.
             * @param[in] intersection Information about the intersection point
             *              and corresponding normal.
