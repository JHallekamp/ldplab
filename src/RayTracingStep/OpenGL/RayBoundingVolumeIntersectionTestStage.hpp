#ifndef WWU_LDPLAB_RTSOGL_RAY_BOUNDING_VOLUME_INTERSECTION_TEST_STAGE_HPP
#define WWU_LDPLAB_RTSOGL_RAY_BOUNDING_VOLUME_INTERSECTION_TEST_STAGE_HPP
...
namespace ldplab
{
    namespace rtsogl
    {
        ...
        public:
            ...
            /** 
             * @brief Inherited via
             * ldplab::rtsogl::IRayBoundingVolumeIntersectionTestStage 
             */
            void setup() override;
            /**
             * @brief Inherited via
