...
ldplab::rtsogl::RodParticleIntersectionTest::
    RodParticleIntersectionTest(Context& context)
    :
    m_context{ context }
{ }

bool ldplab::rtsogl::RodParticleIntersectionTest::initShaders()
{
    // Create shader
...
void ldplab::rtsogl::RodParticleIntersectionTest::execute(
    RayBuffer& rays,
    IntersectionBuffer& intersection)
{
    LDPLAB_LOG_TRACE("RTSOGL context %i: Execute ray particle intersection"\
    ...
    LDPLAB_LOG_TRACE("RTSOGL context %i: Ray particle intersection test on "\
