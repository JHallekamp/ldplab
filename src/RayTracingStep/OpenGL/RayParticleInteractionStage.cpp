...
ldplab::rtsogl::UnpolirzedLight1DLinearIndexGradientInteraction::
...
bool ldplab::rtsogl::UnpolirzedLight1DLinearIndexGradientInteraction::
    initShaders()
{
    // Create shader
...
void ldplab::rtsogl::UnpolirzedLight1DLinearIndexGradientInteraction::execute(
    ...
    OutputBuffer& output)
{
    LDPLAB_LOG_TRACE("RTSOGL context %i: Execute ray particle interaction "\
        "on batch buffer %i",
    ...
    LDPLAB_LOG_TRACE("RTSOGL context %i: Ray particle interaction on batch "\
