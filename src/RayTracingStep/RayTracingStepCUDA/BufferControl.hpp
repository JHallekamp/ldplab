#ifndef WWU_LDPLAB_RTSCUDA_BUFFER_CONTROL_HPP
#define WWU_LDPLAB_RTSCUDA_BUFFER_CONTROL_HPP
...
namespace ldplab
{
    namespace rtscuda
    {
         ...
         * @details In the RTSCUDA pipeline, each ray can be split into two
        ...
        private:
            ...
            std::vector<real_t> m_min_bounding_sphere_distance_data;
