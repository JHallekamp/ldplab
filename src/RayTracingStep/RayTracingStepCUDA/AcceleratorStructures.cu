...
bool ldplab::rtscuda::TriangleMeshGeometryList::intersectRay(
    const Ray& ray,
...
bool ldplab::rtscuda::TriangleMeshGeometryList::constructInternal(
...
bool ldplab::rtscuda::TriangleMeshGeometryOctree::intersectRay(
    const Ray& ray, 
    Vec3& intersection_point, 
    Vec3& intersection_normal,
    double& dist,
...
bool ldplab::rtscuda::TriangleMeshGeometryOctree::constructInternal(
    const std::vector<Triangle>& mesh, 
    const IAcceleratorStructureParameter* parameter)
{
...
size_t ldplab::rtscuda::TriangleMeshGeometryOctree::pow8(size_t exp) const noexcept
{
...
size_t ldplab::rtscuda::TriangleMeshGeometryOctree::mapIndexP2C(
    size_t parent_idx,
...
inline size_t ldplab::rtscuda::TriangleMeshGeometryOctree::mapIndexC2P(
...
inline size_t ldplab::rtscuda::TriangleMeshGeometryOctree::mapIndexGetChildNo(
    size_t child_idx) const noexcept
{
    // child_idx == parent_idx * 8 + child_no
...
ldplab::AABB ldplab::rtscuda::TriangleMeshGeometryOctree::constructOctreeAABB(
    const std::vector<Triangle>& mesh)
{
    AABB octree_aabb;
...
void ldplab::rtscuda::TriangleMeshGeometryOctree::constructConstructionLayers(
...
bool ldplab::rtscuda::TriangleMeshGeometryOctree::constructSortTrianglesRecursive(
...
size_t ldplab::rtscuda::TriangleMeshGeometryOctree::constructMakePersistentRecursive(
...
bool ldplab::rtscuda::TriangleMeshGeometryOctree::intersectRecursive(
...
bool ldplab::rtscuda::TriangleMeshGeometryOctree::intersectBase(
...
ldplab::rtscuda::TriangleMeshGeometryOctree::OctreeNode::OctreeNode()
    :
    num_children{ 0 },
    children{ 0 }
{
