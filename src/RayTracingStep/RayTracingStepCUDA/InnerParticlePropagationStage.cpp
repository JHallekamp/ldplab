...
ldplab::real_t ldplab::rtscuda::EikonalSolverRK45LinearIndexGradient::rk45(
    const ParticleMaterialLinearOneDirectional* particle,
    const Arg& x,
    const real_t h,
    Arg& x_new) const
...
ldplab::real_t ldplab::rtscuda::EikonalSolverRK45LinearIndexGradient::Arg::absoluteMax()
{
