...
ldplab::rtscuda::RayParticleGenericGeometryIntersectionTest::
...
void ldplab::rtscuda::RayParticleGenericGeometryIntersectionTest::execute(
    RayBuffer& rays, 
    IntersectionBuffer& intersection)
{
    LDPLAB_LOG_TRACE("RTSCUDA context %i: Execute ray particle intersection"\
    ...
    LDPLAB_LOG_TRACE("RTSCUDA context %i: Ray particle intersection test on "\
